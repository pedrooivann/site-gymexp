...
`<section>
  ...
  <h3>Treino Principal</h3>
   <ul>
    <li>1. Agachamento (Squat) — 3x12</li>
    <li>2. Flexão de braço (Push-up) — 3x8–12</li>
    <li>3. Remada com elástico / TRX / mochila — 3x12</li>
    <li>4. Avanço (Lunge) — 3x10 por perna</li>
  ...
  <h3>Aquecimento (3-5 min)</h3>
   <ul>
    <li>Marcha com elevação de joelho — 1 min</li>
    <li>Mobilidade torácica e de quadril — 2 min</li>
   </ul>
   <br>

  <h3>Treino Principal</h3>
   <ul>
    <li>1. Prancha lateral — 3x20–30s cada lado</li>
    <li>2. Ponte de glúteo (Glute Bridge) — 3x15</li>
    <li>3. Agachamento unilateral apoiado (Pistol assistido) — 3x8 por perna</li>
  ...
  <h3>30s cada exercício / 15s de descanso / 3 a 4 voltas</h3>
   <ul>
    <li>1. Burpee</li>
    <li>2. Kettlebell swing / mochila swing</li>
    <li>3. Agachamento com salto (Jump Squat)</li>
    <li>4. Corrida estacionária (alta velocidade)</li>
